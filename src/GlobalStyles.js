...
const styles = css`
  ...
  * {
  ...
  :root {
    ...
    --shadow-elevation-low: 0.3px 0.5px 0.7px hsl(var(--primary-hsl) / 0.24),
      0.4px 0.8px 1px -1.2px hsl(var(--primary-hsl) / 0.24),
      0.9px 1.7px 2.2px -2.5px hsl(var(--primary-hsl) / 0.24);
    --shadow-elevation-medium: 0.3px 0.5px 0.7px hsl(var(--primary-hsl) / 0.25),
    ...
    --shadow-elevation-high: 0.3px 0.5px 0.7px hsl(var(--primary-hsl) / 0.23),
